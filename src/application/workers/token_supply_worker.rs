...
use crate::domain::models::{Source, Token};
...
mod tests {
    ...
    use crate::domain::models::{Source, TokenSupply};
    ...
    async fn worker_fetches_and_updates_on_interval() {
        ...
        // Act.
        let worker = TokenSupplyWorker::new(service, token, sources, 1);
        worker.start().await;
